  ...
  return (
    <main className="min-h-screen bg-white relative">
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] w-14 h-14 flex items-center justify-center rounded-full shadow-lg hover:bg-[#128C7E] transition-colors duration-300"
